...
public class ExtentReportListener implements ITestListener {
 ...
 // test.log(LogStatus.FAIL, result.getMethod().getMethodName() + "test is failed");
  ...
  try {
   FileUtils.copyFile(src, new File("C:\\Users\\ssrivastava4\\workspace\\PulseProject3\\screenshots\\"+result.getMethod().getMethodName() + ".png"));
   
   String file = test.addScreenCapture("C:\\Users\\ssrivastava4\\workspace\\PulseProject3\\screenshots\\"+result.getMethod().getMethodName() + ".png");
